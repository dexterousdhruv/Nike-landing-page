  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className='mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[] font-bold '>
        ...
        '> 
        Dicover stylish Nike arrivals, quality, comfort and innovation for your active life.</p>
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-center bg-cover">
        <img src={bigShoeImg} alt="shoe collection" width={610} height={50} className=' object-contain relative z-10' />

      
        <div className='flex sm:gap-6 gap-4 absolute -bottom-[12%] sm:left-[10%] max-sm:px-6'>
          {shoes.map((shoe) => (
            <div className='flex justify-center' key={shoe}>
              <ShoeCard
                imgURL={shoe}
